...
eval_args.add_argument('--eval_emd', action='store_true',default=True, help='Calculate Earth Mover\'s Distance')
...
eval_args.add_argument('--eval_nll', action='store_true',default=True, help='Calculate negative log likelihood')
eval_args.add_argument('--eval_chamfer', action='store_true',default=True, help='Calculate Chamfer Distance (using `chamferdist`)')
eval_args.add_argument('--vis_overlay', action='store_true',default=True, help='Overlays predicted distribution on top of ground truth')
eval_args.add_argument('--vis_diffusion', action='store_true',default=False, help='Shows the evolution of samples through the diffusion process via an animation')
eval_args.add_argument('--vis_track_max', action='store_true',default=True, help='Track the point with highest Z in the predicted distribution in diffusion animation')
eval_args.add_argument('--vis_track_min', action='store_true',default=True, help='Track the point with lowest Z in the predicted distribution in diffusion animation')
eval_args.add_argument('--vis_smoothed_end', action='store_true',default=False, help='Smooths the end of animation by repeating the last frame of animation')
